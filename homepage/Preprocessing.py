...
class DatasetSplitter(BaseEstimator, TransformerMixin):
    ...
    """This class splits the whole dataset into three sets:training, validation and test"""
    
    def __init__(self, PATH, to_drop=None):
    ...
    def transform(self,X,y=None):
        ...
        if not os.path.exists(os.path.join(self.__path, "train.pkl")):
            ...
            infile = open(os.path.join(self.__path, "train.pkl"),"rb")
